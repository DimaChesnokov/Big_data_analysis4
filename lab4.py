...
def test_hypotheses(df):
    ...
    print("\nГипотеза 1: Средний уровень глюкозы у диабетиков выше, чем у здоровых людей.")
    ...
    print("\nГипотеза 2: Корреляция между BMI и уровнем глюкозы положительная.")
...
class CustomLinearRegression:
    def __init__(self, learning_rate=1e-3, n_iterations=5000, l2_penalty=0.1, clip_value=1.0):
...
if __name__ == "__main__":
    file_path = "diabetes.csv"  # Укажите путь к файлу, если он не в текущей директории
    ...
    target_column = "BMI"  # Целевая переменная
    feature_column = "Glucosse"  # Признак для визуализации
    ...
    # Сохранение модели
    save_model(trained_models["Custom Linear Regression"], "custom_linear_regression.pkl")
